...
function init_3mm!(
    ...
    # Column-major initialization (j outer, i inner)
...
function kernel_3mm_tiled!(
    ...
    # E = A * B (tiled, parallelized over column tiles)
...
function get_kernel(strategy::String)
    ...
    return get(kernels, strategy, kernel_3mm_seq!)
end
